...
public class FtpUploader
{
    ...
    String filePath = "/data/data/org.graduation.healthylife/"+"databases/HealthyLife.db";
    String fileStorePath="/data/data/org.graduation.healthylife/"+"databases/";
    ...
    {
        String fileName= getStudnetId()+"_"+getSubmitId()+".db";
        String storePath=fileStorePath+fileName;
...
//        }Log.e("sub","after refresh:"+j);
        ...
        String dirPath="/data/data/org.graduation.healthylife/"+"databases";
        File file=new File(dirPath);//System.out.println(dirList[i]);
        File fileList[]=file.listFiles();
        for(int i=0;i<fileList.length;++i)
        {
            Log.e("file",fileList[i]+"");
            if((fileList[i]+"").contains(filePath) ==true ) continue;
            else
            {
                String storeName=getStudnetId()+"_store"+i+".db";
                //upload(fileList[i]+"",storeName);
            }
        }
        return result;
    }
